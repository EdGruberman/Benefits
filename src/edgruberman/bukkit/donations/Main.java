...
import edgruberman.bukkit.donations.messaging.couriers.ConfigurationCourier;
import edgruberman.bukkit.donations.messaging.couriers.TimestampedConfigurationCourier;

public final class Main extends JavaPlugin {

    private static final Version MINIMUM_CONFIGURATION = new Version("0.0.0a51");
    ...
    public void onEnable() {
        ...
        final File pending = new File(this.getDataFolder(), this.getConfig().getString("coordinator.pending"));
        final File incoming = new File(this.getDataFolder(), this.getConfig().getString("coordinator.incoming"));
        final File processed = new File(this.getDataFolder(), this.getConfig().getString("coordinator.processed"));
        this.coordinator = new Coordinator(this, this.getConfig().getConfigurationSection("packages"), this.getConfig().getInt("coordinator.period"), pending, incoming, processed);
